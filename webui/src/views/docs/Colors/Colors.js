    ...
    <Box>
              ...
              <Grid container spacing={4}>
                <Grid item xs={12} md={6}>
                  ...
                  <Grid container spacing={2}>
                    {[
                      item.palette.primary.light,
                      item.palette.primary.main,
                      item.palette.primary.dark,
                    ].map((color) => (
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Grid container spacing={2}>
                    {[
                      item.palette.secondary.light,
                      item.palette.secondary.main,
                      item.palette.secondary.dark,
                    ].map((color) => (
                      <Grid item xs={12} sm={4} key={color}>
                        <Box component={Card} boxShadow={3} borderRadius={4}>
                          <Box width={1} height={200} bgcolor={color} />
      ...
      <Container paddingTop={'0 !important'}>
        <Box marginBottom={4}>
          ...
          >
            The available color types are declared in{' '}
            <code>src/common/paletteTypes.js</code>
          </Typography>
          <Box marginBottom={2}>
            {renderCodeBlock(
...
export default palettes;`,
          ...
          <Typography gutterBottom>
            First, add you new theme color in the array mentioned above. The
            colors should be picked from{' '}
            <Link
              href={
                'https://next.material-ui.com/customization/color/#color-palette'
              }
              target={'_blank'}
            >
          ...
          >
            Then, create a new file in <code>src/theme</code> and name it{' '}
            <code>palette--[your color name].js</code>, where{' '}
            <code>[your color name]</code> is the name of your color, for
          ...
          >
            The color palette should be created by following to already existing
            palette object and{' '}
            <Link
              href={'https://next.material-ui.com/customization/color/'}
              target={'_blank'}
            >
          ...
          >
            Finaly, open <code>src/palette.js</code> file and add a new case for
            your new color. That's it!
          </Typography>
          <Box marginTop={4}>
            <Typography
              variant="h6"
